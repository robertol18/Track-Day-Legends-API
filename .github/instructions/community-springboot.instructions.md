---
description: 'Community Spring Boot guidance scoped to adapters/infrastructure for this Hexagonal DDD project'
applyTo: 'src/main/java/**/adapter/**/*.java, src/main/java/**/infrastructure/**/*.java, src/main/java/**/*Application.java'
---

# Spring Boot Development

## Repository Scope Overlay

- This community file is intentionally scoped to adapters and infrastructure packages.
- Domain and application layers are governed by local architecture instructions and must remain framework-free.
- Do not introduce `@Service` or other Spring stereotypes in `application` or `domain` packages.
